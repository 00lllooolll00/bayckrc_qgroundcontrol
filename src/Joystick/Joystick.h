...
public:
    AvailableButtonAction(const QString& actionName, std::function<void()> onDown, std::function<void()> onUp = nullptr,
                          std::function<void()> onRepeat = nullptr, QObject* parent = nullptr);
...
public:
    ...
    Q_INVOKABLE virtual void rumble(quint16 lowFreq, quint16 highFreq, quint32 durationMs)
    {
        Q_UNUSED(lowFreq);
        Q_UNUSED(highFreq);
        Q_UNUSED(durationMs);
    ...
    Q_INVOKABLE virtual void rumbleTriggers(quint16 left, quint16 right, quint32 durationMs)
    {
        Q_UNUSED(left);
        Q_UNUSED(right);
        Q_UNUSED(durationMs);
    ...
    Q_INVOKABLE virtual void setLED(quint8 red, quint8 green, quint8 blue)
    {
        Q_UNUSED(red);
        Q_UNUSED(green);
        Q_UNUSED(blue);
    ...
    Q_INVOKABLE virtual QString axisLabel(int axis) const
    {
        Q_UNUSED(axis);
        return QString();
    }

    Q_INVOKABLE virtual QString buttonLabel(int button) const
    {
        Q_UNUSED(button);
        return QString();
    }
    ...
    Q_INVOKABLE virtual bool addMapping(const QString& mapping)
    {
        Q_UNUSED(mapping);
        return false;
    }
    ...
    Q_INVOKABLE virtual bool setGyroscopeEnabled(bool enabled)
    {
        Q_UNUSED(enabled);
        return false;
    }

    Q_INVOKABLE virtual bool setAccelerometerEnabled(bool enabled)
    {
        Q_UNUSED(enabled);
        return false;
    }
    ...
    Q_INVOKABLE virtual int touchpadFingerCount(int touchpad) const
    {
        Q_UNUSED(touchpad);
        return 0;
    }
    ...
    // Trackball support
    Q_INVOKABLE virtual QVariantMap getBall(int ball) const
    {
        Q_UNUSED(ball);
        return QVariantMap();
    }
    ...
    Q_INVOKABLE virtual bool sendEffect(const QByteArray& data)
    {
        Q_UNUSED(data);
        return false;
    }
    ...
    Q_INVOKABLE virtual QVariantMap getAxisBinding(int axis) const
    {
        Q_UNUSED(axis);
        return QVariantMap();
    }

    Q_INVOKABLE virtual QVariantMap getButtonBinding(int button) const
    {
        Q_UNUSED(button);
        return QVariantMap();
    }
    ...
    // Capability queries
    Q_INVOKABLE virtual bool hasButton(int button) const
    {
        Q_UNUSED(button);
        return false;
    }

    Q_INVOKABLE virtual bool hasAxis(int axis) const
    {
        Q_UNUSED(axis);
        return false;
    }
    ...
    Q_INVOKABLE virtual QString buttonLabelForType(int button) const
    {
        Q_UNUSED(button);
        return QString();
    }
    ...
    Q_INVOKABLE virtual bool hapticRumblePlay(float strength, quint32 durationMs)
    {
        Q_UNUSED(strength);
        Q_UNUSED(durationMs);
        return false;
    ...
    Q_INVOKABLE virtual QString getMappingForGUID(const QString& guid) const
    {
        Q_UNUSED(guid);
        return QString();
    }
    ...
    Q_INVOKABLE virtual bool setVirtualAxis(int axis, int value)
    {
        Q_UNUSED(axis);
        Q_UNUSED(value);
        return false;
    ...
    Q_INVOKABLE virtual bool setVirtualButton(int button, bool down)
    {
        Q_UNUSED(button);
        Q_UNUSED(down);
        return false;
    ...
    Q_INVOKABLE virtual bool setVirtualHat(int hat, quint8 value)
    {
        Q_UNUSED(hat);
        Q_UNUSED(value);
        return false;
    ...
    Q_INVOKABLE virtual bool setVirtualBall(int ball, int dx, int dy)
    {
        Q_UNUSED(ball);
        Q_UNUSED(dx);
        Q_UNUSED(dy);
    ...
    Q_INVOKABLE virtual QVariantMap getAxisInitialState(int axis) const
    {
        Q_UNUSED(axis);
        return QVariantMap();
    }
    ...
    Q_INVOKABLE virtual bool setMapping(const QString& mapping)
    {
        Q_UNUSED(mapping);
        return false;
    }
    ...
    RemoteControlCalibrationController::StickFunction mapAxisFunctionToRCCStickFunction(
        AxisFunction_t axisFunction) const;
    AxisFunction_t mapRCCStickFunctionToAxisFunction(
    ...
    Q_INVOKABLE void startConfiguration();  ///< Tells the joystick that the configuration UI is being displayed so it
                                            ///< can do any special processing required
    Q_INVOKABLE void stopConfiguration();   ///< Tells the joystick that the configuration UI is being closed so it can
                                            ///< do any special processing required
...
signals:
    ...
    void vehicleJoystickData(float roll, float pitch, float yaw, float throttle, uint16_t buttonsLow,
                             uint16_t buttonsHigh, float gimbalPitch, float gimbalYaw);
...
private:
    ...
    AxisFunctionMap_t _axisFunctionToJoystickAxisMap;  ///< Map from AxisFunction_t to axis index,
                                                       ///< kJoystickAxisNotAssigned if not assigned
