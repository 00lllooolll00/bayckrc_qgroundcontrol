...
public:
    ...
    Q_PROPERTY(bool showCreateFromTemplate READ showCreateFromTemplate NOTIFY
                   showCreateFromTemplateChanged)  ///< true: No plan items and not in manual-creation mode; UI should
                                                   ///< show "create new plan" template selection
    Q_PROPERTY(bool syncInProgress READ syncInProgress NOTIFY
                   syncInProgressChanged)  ///< true: Information is currently being saved/sent, false: no active
                                           ///< save/send in progress
    Q_PROPERTY(
        bool dirtyForSave READ dirtyForSave NOTIFY dirtyForSaveChanged)  ///< true: Unsaved changes to disk are present,
                                                                         ///< false: no changes since last save to disk
    Q_PROPERTY(bool dirtyForUpload READ dirtyForUpload NOTIFY
                   dirtyForUploadChanged)  ///< true: Unsent changes are present, false: no changes since last
    ...
    Q_PROPERTY(QString currentPlanFile READ currentPlanFile NOTIFY
                   currentPlanFileChanged)  ///< Fully qualified path, empty if not yet saved
    Q_PROPERTY(QString currentPlanFileName READ currentPlanFileName NOTIFY
                   currentPlanFileChanged)  ///< Base name of currentPlanFile, no path or extension
    ...
    Q_PROPERTY(bool userSelectedManualCreation READ userSelectedManualCreation WRITE setUserSelectedManualCreation
                   NOTIFY userSelectedManualCreationChanged)  ///< true: User is not using a template to create the plan
