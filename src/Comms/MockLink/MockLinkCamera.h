...
public:
    ...
    explicit MockLinkCamera(MockLink* mockLink, bool captureVideo = true, bool captureImage = true,
                            bool hasModes = true, bool hasVideoStream = true, bool canCaptureImageInVideoMode = true,
                            bool canCaptureVideoInImageMode = false, bool hasBasicZoom = true,
                            bool hasTrackingPoint = false, bool hasTrackingRectangle = false);
