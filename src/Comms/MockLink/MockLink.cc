...
void MockLink::_sendHeartBeat()
{
    ...
    const uint8_t mavState =
        (_vehicleAltitudeAMSL > _defaultVehicleHomeAltitude) ? MAV_STATE_ACTIVE : MAV_STATE_STANDBY;
...
void MockLink::_sendHighLatency2()
{
    ...
    mavlink_message_t msg{};
    (void) mavlink_msg_high_latency2_pack_chan(_vehicleSystemId, _vehicleComponentId, _outgoingMavlinkChannel, &msg,
                                               0,                      // timestamp
                                               _vehicleType,           // MAV_TYPE
                                               _firmwareType,          // MAV_AUTOPILOT
...
void MockLink::_sendBatteryStatus()
{
    ...
    (void) mavlink_msg_battery_status_pack_chan(_vehicleSystemId, _vehicleComponentId, _outgoingMavlinkChannel, &msg,
                                                1,     // battery id
                                                ...
                                                _battery1PctRemaining, _battery1TimeRemaining, _battery1ChargeState,
                                                rgVoltagesExtNone,
                                                0,  // MAV_BATTERY_MODE
                                                0   // MAV_BATTERY_FAULT
    );
    ...
    (void) mavlink_msg_battery_status_pack_chan(_vehicleSystemId, _vehicleComponentId, _outgoingMavlinkChannel, &msg,
                                                ...
                                                100,        // current consumed mAh
                                                -1,         // energy consumed not supported
                                                _battery2PctRemaining, _battery2TimeRemaining, _battery2ChargeState,
                                                rgVoltagesExtNone,
                                                0,  // MAV_BATTERY_MODE
                                                0   // MAV_BATTERY_FAULT
    );
...
{
    mavlink_message_t msg{};
    (void) mavlink_msg_vibration_pack_chan(_vehicleSystemId, _vehicleComponentId, _outgoingMavlinkChannel, &msg,
                                           0,     // time_usec
                                           50.5,  // vibration_x,
                                           10.5,  // vibration_y,
                                           60.0,  // vibration_z,
...
void MockLink::_handleManualControl(const mavlink_message_t& msg)
{
    ...
    qCDebug(MockLinkVerboseLog).noquote()
        << "MANUAL_CONTROL" << "target:" << manualControl.target << "x:" << axisStr(manualControl.x)
        << "y:" << axisStr(manualControl.y) << "z:" << axisStr(manualControl.z) << "r:" << axisStr(manualControl.r)
    ...
    if (_currentParamRequestListParamIndex >= cParameters) {
        ...
        if (_firmwareType == MAV_AUTOPILOT_PX4 && !_paramRequestListHashCheckSent) {
            ...
            (void) mavlink_msg_param_value_pack_chan(
                _vehicleSystemId, componentId, _outgoingMavlinkChannel, &responseMsg, paramId, valueUnion.param_float,
...
void MockLink::_handleInProgressCommandLong(const mavlink_command_long_t& request)
{
    ...
    (void) mavlink_msg_command_ack_pack_chan(_vehicleSystemId, _vehicleComponentId, _outgoingMavlinkChannel,
                                             &commandAck, request.command, MAV_RESULT_IN_PROGRESS,
                                             1,  // progress
                                             0,  // result_param2
                                             0,  // target_system
                                             0   // target_component
    ...
    if (request.command != MockLink::MAV_CMD_MOCKLINK_RESULT_IN_PROGRESS_NO_ACK) {
        (void) mavlink_msg_command_ack_pack_chan(_vehicleSystemId, _vehicleComponentId, _outgoingMavlinkChannel,
                                                 &commandAck, request.command, commandResult,
                                                 0,  // progress
                                                 0,  // result_param2
                                                 0,  // target_system
                                                 0   // target_component
...
void MockLink::_respondWithAutopilotVersion()
{
    ...
    (void) mavlink_msg_autopilot_version_pack_chan(
        _vehicleSystemId, _vehicleComponentId, _outgoingMavlinkChannel, &msg, capabilities,
...
void MockLink::_sendAttitudeTarget()
{
    ...
    (void) mavlink_msg_attitude_target_pack_chan(_vehicleSystemId, _vehicleComponentId, _outgoingMavlinkChannel, &msg,
                                                 ...
                                                 qSp, bodyRollRate, bodyPitchRate, bodyYawRate,
                                                 0.5f  // thrust
    );
    respondWithMavlinkMessage(msg);
}
...
void MockLink::_sendPositionTargetLocalNed()
{
    ...
    (void) mavlink_msg_position_target_local_ned_pack_chan(
        _vehicleSystemId, _vehicleComponentId, _outgoingMavlinkChannel, &msg, timeBootMs, MAV_FRAME_LOCAL_NED,
        0,                                      // type_mask: all fields valid
        x, y, z, vx, vy, vz, 0.0f, 0.0f, 0.0f,  // acceleration not used
...
{
    mavlink_message_t msg{};
    (void) mavlink_msg_rc_channels_pack_chan(_vehicleSystemId, _vehicleComponentId, _outgoingMavlinkChannel, &msg,
                                             0,                                               // time_boot_ms
                                             16,                                              // chancount
...
void MockLink::_handleLogRequestList(const mavlink_message_t& msg)
{
    ...
    mavlink_message_t responseMsg{};
    mavlink_msg_log_entry_pack_chan(_vehicleSystemId, _vehicleComponentId, _outgoingMavlinkChannel, &responseMsg,
                                    logId,    // log id
                                    numLogs,  // num_logs
...
void MockLink::_sendEscInfo()
{
    ...
    mavlink_message_t msg{};
    (void) mavlink_msg_esc_info_pack_chan(_vehicleSystemId, _vehicleComponentId, _outgoingMavlinkChannel, &msg,
                                          ...
                                          failureFlags, errorCount, temperature);
    respondWithMavlinkMessage(msg);
}
...
void MockLink::_sendEscStatus()
{
    ...
    mavlink_message_t msg{};
    (void) mavlink_msg_esc_status_pack_chan(_vehicleSystemId, _vehicleComponentId, _outgoingMavlinkChannel, &msg,
                                            0,                                                     // index: first group
                                            static_cast<uint64_t>(_runningTime.elapsed()) * 1000,  // time_usec
                                            rpm, voltage, current);
    respondWithMavlinkMessage(msg);
...
void MockLink::_sendRadioStatus()
{
    ...
    mavlink_message_t msg{};
    (void) mavlink_msg_radio_status_pack_chan(_vehicleSystemId, _vehicleComponentId, _outgoingMavlinkChannel, &msg,
