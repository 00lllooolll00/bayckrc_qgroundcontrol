    ...
    runWithMockLink([] { return MockLink::startPX4MockLink(); },
                    [&](QPointer<MockLink> /*mockLink*/, Vehicle* vehicle) {
                        ...
                        QVERIFY2(clickButton(QStringLiteral("vehicleConfig_summary")),
                                 "Failed to click Summary button");
...
void PX4VehicleConfigUITest::_testSidebarDividers()
{
    runWithMockLink([] { return MockLink::startPX4MockLink(); },
                    [&](QPointer<MockLink> /*mockLink*/, Vehicle* /*vehicle*/) {
                        ...
                        QQuickItem* const summaryDivider =
                            findItem(_rootItem, QStringLiteral("vehicleConfig_summaryDivider"));
                        QQuickItem* const componentsDivider =
                            findItem(_rootItem, QStringLiteral("vehicleConfig_componentsDivider"));
                        ...
                        QQuickItem* const searchField =
                            findVisibleItem(_rootItem, QStringLiteral("vehicleConfig_searchField"), 3000);
                        QVERIFY(searchField);
...
void PX4VehicleConfigUITest::_testDisconnectWithPIDTuningOpen()
{
    runWithMockLink(
        ...
        [&](QPointer<MockLink> /*mockLink*/, Vehicle* /*vehicle*/) {
            ...
            QVERIFY2(clickButton(QStringLiteral("pidTuning_tab_RateController")),
                     "Failed to click Rate Controller tab");
            QTest::qWait(_pageDelay);
            _cycleAxisButtons(
                {QStringLiteral("Roll"), QStringLiteral("Pitch"), QStringLiteral("Yaw"), QStringLiteral("Roll")});
            if (QTest::currentTestFailed())
                return;
            ...
            QVERIFY2(clickButton(QStringLiteral("pidTuning_tab_AttitudeController")),
                     "Failed to click Attitude Controller tab");
            QTest::qWait(_pageDelay);
            _cycleAxisButtons(
                {QStringLiteral("Roll"), QStringLiteral("Pitch"), QStringLiteral("Yaw"), QStringLiteral("Roll")});
            if (QTest::currentTestFailed())
            ...
            QVERIFY2(clickButton(QStringLiteral("pidTuning_tab_VelocityController")),
                     "Failed to click Velocity Controller tab");
            QTest::qWait(_pageDelay);
            ...
            QVERIFY2(clickButton(QStringLiteral("pidTuning_tab_PositionController")),
                     "Failed to click Position Controller tab");
            QTest::qWait(_pageDelay);
            _cycleAxisButtons({QStringLiteral("Horizontal"), QStringLiteral("Vertical"), QStringLiteral("Horizontal")});
            if (QTest::currentTestFailed())
                return;
